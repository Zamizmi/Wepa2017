  ...
  describe "in case of cache miss" do
    ...
    describe "when HTTP GET returns" do
      it "one entry, it is parsed and returned" do
        ...
        <reviewlink>https://beermapping.com/location/12411</reviewlink>
      ...
      it "no entries returns nil and tells it" do
        canned_answer = <<-END_OF_STRING
        <?xml version='1.0' encoding='utf-8' ?><bmp_locations><location>
        <id></id>
        <name></name>
      ...
      it "many entries, they are parsed and returned" do
        canned_answer = <<-END_OF_STRING
        <?xml version='1.0' encoding='utf-8' ?><bmp_locations><location><id>13307</id>
        <name>O'Connell's Irish Bar</name><status>Beer Bar</status>
        <reviewlink>https://beermapping.com/location/13307</reviewlink>
        ...
        <street>Rautatienkatu 24</street><city>Tampere</city><state></state>
        <zip>33100</zip><country>Finland</country><phone>35832227032</phone>
        <overall>0</overall><imagecount>0</imagecount

        ></location><location><id>18845</id>
        <name>Pyynikin kà¤sityà¶là¤ispanimo</name><status>Brewery</status>
        <reviewlink>https://beermapping.com/location/18845</reviewlink>
        ...
        <street>Tesoman valtatie 24</street><city>Tampere</city><state></state><zip>33300</zip>
        <country>Finland</country><phone></phone><overall>0</overall><imagecount>0</imagecount>

        </location><location><id>18857</id><name>Panimoravintola Plevna</name><status>Brewpub</status>
        <reviewlink>https://beermapping.com/location/18857</reviewlink>
        ...
        <street>Ità¤inenkatu 8</street><city>Tampere</city><state></state>
        <zip>33210</zip><country>Finland</country><phone></phone>
        ...
        expect(second.name).to eq("Pyynikin kà¤sityà¶là¤ispanimo")
        expect(second.street).to eq("Tesoman valtatie 24")
        third = places.last
        expect(third.name).to eq("Panimoravintola Plevna")
        expect(third.street).to eq("Ità¤inenkatu 8")
